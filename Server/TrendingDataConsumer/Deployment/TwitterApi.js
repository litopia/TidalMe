(function() {
	'use strict';
	exports.TwitterApi = exports.TwitterApi || {};
	ss.initAssembly(exports, 'TwitterApi');
	////////////////////////////////////////////////////////////////////////////////
	// TwitterApi.Credentials
	var $TwitterApi_Credentials = function() {
		this.consumer_key = null;
		this.consumer_secret = null;
		this.access_token_key = null;
		this.access_token_secret = null;
	};
	$TwitterApi_Credentials.__typeName = 'TwitterApi.Credentials';
	exports.TwitterApi.Credentials = $TwitterApi_Credentials;
	////////////////////////////////////////////////////////////////////////////////
	// TwitterApi.Entities
	var $TwitterApi_Entities = function() {
		this.hashtags = null;
		this.media = null;
	};
	$TwitterApi_Entities.__typeName = 'TwitterApi.Entities';
	exports.TwitterApi.Entities = $TwitterApi_Entities;
	////////////////////////////////////////////////////////////////////////////////
	// TwitterApi.HashTag
	var $TwitterApi_HashTag = function() {
		this.text = null;
	};
	$TwitterApi_HashTag.__typeName = 'TwitterApi.HashTag';
	exports.TwitterApi.HashTag = $TwitterApi_HashTag;
	////////////////////////////////////////////////////////////////////////////////
	// TwitterApi.Media
	var $TwitterApi_Media = function() {
		this.id_str = null;
		this.media_url = null;
		this.type = null;
		this.sizes = null;
	};
	$TwitterApi_Media.__typeName = 'TwitterApi.Media';
	exports.TwitterApi.Media = $TwitterApi_Media;
	////////////////////////////////////////////////////////////////////////////////
	// TwitterApi.SearchOptions
	var $TwitterApi_SearchOptions = function() {
		this.geocode = null;
		this.lang = null;
		this.locale = null;
	...
	$TwitterApi_SearchOptions.__typeName = 'TwitterApi.SearchOptions';
	exports.TwitterApi.SearchOptions = $TwitterApi_SearchOptions;
	////////////////////////////////////////////////////////////////////////////////
	// TwitterApi.Size
	var $TwitterApi_Size = function() {
		this.w = 0;
		this.h = 0;
		this.resize = null;
	};
	$TwitterApi_Size.__typeName = 'TwitterApi.Size';
	exports.TwitterApi.Size = $TwitterApi_Size;
	////////////////////////////////////////////////////////////////////////////////
	// TwitterApi.Sizes
	...
	$TwitterApi_Trend.__typeName = 'TwitterApi.Trend';
	exports.TwitterApi.Trend = $TwitterApi_Trend;
	////////////////////////////////////////////////////////////////////////////////
	// TwitterApi.TrendsContainer
	var $TwitterApi_TrendsContainer = function() {
		this.as_of = new Date(0);
		this.created_at = new Date(0);
		this.trends = null;
	};
	$TwitterApi_TrendsContainer.__typeName = 'TwitterApi.TrendsContainer';
	exports.TwitterApi.TrendsContainer = $TwitterApi_TrendsContainer;
	////////////////////////////////////////////////////////////////////////////////
	// TwitterApi.TrendsCredentialsUtils
	var $TwitterApi_TrendsCredentialsUtils = function() {
	};
	$TwitterApi_TrendsCredentialsUtils.__typeName = 'TwitterApi.TrendsCredentialsUtils';
	$TwitterApi_TrendsCredentialsUtils.getNextCredential = function() {
		return Enumerable.from($TwitterApi_TrendsCredentialsUtils.$m_ValidCredentials).first();
	};
	$TwitterApi_TrendsCredentialsUtils.invalidateCredential = function() {
		// Put the invalidated one at the end
		var hold = Enumerable.from($TwitterApi_TrendsCredentialsUtils.$m_ValidCredentials).first();
		ss.removeAt($TwitterApi_TrendsCredentialsUtils.$m_ValidCredentials, 0);
		ss.add($TwitterApi_TrendsCredentialsUtils.$m_ValidCredentials, hold);
	};
	exports.TwitterApi.TrendsCredentialsUtils = $TwitterApi_TrendsCredentialsUtils;
	////////////////////////////////////////////////////////////////////////////////
	// TwitterApi.TrendsUtils
	var $TwitterApi_TrendsUtils = function() {
	};
	$TwitterApi_TrendsUtils.__typeName = 'TwitterApi.TrendsUtils';
	$TwitterApi_TrendsUtils.getTrend = function(creds, woeid) {
	...
	$TwitterApi_TrendsUtils.getTrendLocations = function(creds) {
	...
	$TwitterApi_TrendsUtils.getValidCredentials = function() {
		var $t1 = [];
		var $t2 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t2);
		null;
		var $t3 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t3);
		null;
		var $t4 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t4);
		null;
		var $t5 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t5);
		null;
		var $t6 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t6);
		null;
		var $t7 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t7);
		null;
		var $t8 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t8);
		null;
		var $t9 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t9);
		null;
		var $t10 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t10);
		null;
		var $t11 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t11);
		null;
		var $t12 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t12);
		null;
		var $t13 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t13);
		null;
		var $t14 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t14);
		null;
		var $t15 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t15);
		null;
		var $t16 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t16);
		null;
		var $t17 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t17);
		null;
		var $t18 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t18);
		null;
		var $t19 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t19);
		null;
		var $t20 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t20);
		null;
		var $t21 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t21);
		null;
		var $t22 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t22);
		null;
		var $t23 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t23);
		null;
		var $t24 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t24);
		null;
		var $t25 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t25);
		null;
		var $t26 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t26);
		null;
		var $t27 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t27);
		null;
		var $t28 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t28);
		null;
		var $t29 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t29);
		null;
		var $t30 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t30);
		null;
		var $t31 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t31);
		null;
		var $t32 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t32);
		null;
		var $t33 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t33);
		null;
		var $t34 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t34);
		null;
		var $t35 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t35);
		null;
		var $t36 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t36);
		null;
		var $t37 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t37);
		null;
		var $t38 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t38);
		null;
		var $t39 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t39);
		null;
		var $t40 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t40);
		null;
		var $t41 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t41);
		null;
		var $t42 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t42);
		null;
		var $t43 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t43);
		null;
		var $t44 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t44);
		null;
		var $t45 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t45);
		null;
		var $t46 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t46);
		null;
		var $t47 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t47);
		null;
		var $t48 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t48);
		null;
		var $t49 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t49);
		null;
		var $t50 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t50);
		null;
		var $t51 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t51);
		null;
		var $t52 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t52);
		null;
		var $t53 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t53);
		null;
		var $t54 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t54);
		null;
		var $t55 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t55);
		null;
		var $t56 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t56);
		null;
		var $t57 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t57);
		null;
		var $t58 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t58);
		null;
		var $t59 = new $TwitterApi_Credentials();
		...
		ss.add($t1, $t59);
		null;
		var $t60 = new $TwitterApi_Credentials();
	...
	$TwitterApi_TrendsUtils.searchTweets = function(creds, query, searchOptions) {
		var $state = 0, $tcs = new ss.TaskCompletionSource(), tcs, twitter, twitterObj;
		var $sm = function() {
			try {
				$sm1:
				for (;;) {
					switch ($state) {
						case 0: {
							...
							twitter = require('twitter');
							twitterObj = new twitter(creds);
							twitterObj.search(query, searchOptions, function(data) {
								if (data.toString().indexOf('Too Many Requests') !== -1) {
									// error
									console.info('Search Error: ' + data);
									tcs.setException(new ss.Exception('Too Many Requests'));
									return;
								}
	...
	exports.TwitterApi.TrendsUtils = $TwitterApi_TrendsUtils;
	////////////////////////////////////////////////////////////////////////////////
	// TwitterApi.Tweet
	var $TwitterApi_Tweet = function() {
	...
	$TwitterApi_Tweet.__typeName = 'TwitterApi.Tweet';
	exports.TwitterApi.Tweet = $TwitterApi_Tweet;
	////////////////////////////////////////////////////////////////////////////////
	// TwitterApi.TwitterFactory
	var $TwitterApi_TwitterFactory = function() {
	};
	$TwitterApi_TwitterFactory.__typeName = 'TwitterApi.TwitterFactory';
	exports.TwitterApi.TwitterFactory = $TwitterApi_TwitterFactory;
	////////////////////////////////////////////////////////////////////////////////
	// TwitterApi.TwitterTrendsLocation
	var $TwitterApi_TwitterTrendsLocation = function() {
		this.name = null;
		this.placeType = null;
		this.url = null;
		this.parentid = 0;
	...
	$TwitterApi_TwitterTrendsLocation.__typeName = 'TwitterApi.TwitterTrendsLocation';
	exports.TwitterApi.TwitterTrendsLocation = $TwitterApi_TwitterTrendsLocation;
	////////////////////////////////////////////////////////////////////////////////
	// TwitterApi.TwitterTrendsPlaceType
	var $TwitterApi_TwitterTrendsPlaceType = function() {
		this.code = 0;
		this.name = null;
	};
	$TwitterApi_TwitterTrendsPlaceType.__typeName = 'TwitterApi.TwitterTrendsPlaceType';
	exports.TwitterApi.TwitterTrendsPlaceType = $TwitterApi_TwitterTrendsPlaceType;
	////////////////////////////////////////////////////////////////////////////////
	// TwitterApi.User
	var $TwitterApi_User = function() {
		this.lang = null;
		this.location = null;
		this.name = null;
	...
	$TwitterApi_User.__typeName = 'TwitterApi.User';
	exports.TwitterApi.User = $TwitterApi_User;
	ss.initClass($TwitterApi_Credentials, exports, {});
	ss.initClass($TwitterApi_Entities, exports, {});
	ss.initClass($TwitterApi_HashTag, exports, {});
	ss.initClass($TwitterApi_Media, exports, {});
	ss.initClass($TwitterApi_SearchOptions, exports, {});
	ss.initClass($TwitterApi_Size, exports, {});
	ss.initClass($TwitterApi_Sizes, exports, {});
	ss.initClass($TwitterApi_Trend, exports, {});
	ss.initClass($TwitterApi_TrendsContainer, exports, {});
	ss.initClass($TwitterApi_TrendsCredentialsUtils, exports, {});
	ss.initClass($TwitterApi_TrendsUtils, exports, {});
	ss.initClass($TwitterApi_Tweet, exports, {});
	ss.initClass($TwitterApi_TwitterFactory, exports, {});
	ss.initClass($TwitterApi_TwitterTrendsLocation, exports, {});
	ss.initClass($TwitterApi_TwitterTrendsPlaceType, exports, {});
	ss.initClass($TwitterApi_User, exports, {});
	$TwitterApi_TrendsCredentialsUtils.$m_ValidCredentials = null;
	$TwitterApi_TrendsCredentialsUtils.$m_ValidCredentials = $TwitterApi_TrendsUtils.getValidCredentials();
})();
